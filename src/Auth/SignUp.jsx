...
const SignUp = () => {
    const { googleUser, signUpUsers } = useContext(AuthContext)
             ...
             <div className="w-full bg-[#F4F3F0] border border-neutral-300 max-w-4xl mx-auto rounded-md shadow sm:p-10 p-4">
              ...
              />
                 ...
                 <button
                   ...
                   className="flex hover:border-black hover:bg-[#3d1f1acc] hover:text-white items-center justify-center w-full p-4 text-lg font-semibold space-x-4 border-2 rounded-md focus:ring-2 focus:ring-offset-1 "
                 >
                   <svg
