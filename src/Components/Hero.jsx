...
const Hero = () => {
    return (
        <div>
             <div style={{ backgroundImage: `url(${'/hero.png'})` , backgroundRepeat:'no-repeat', backgroundPosition:'center', backgroundSize: 'cover'}} className="h-[620px] md:h-[calc(100vh-110px)] w-full text-white flex items-center rancho justify-end">
