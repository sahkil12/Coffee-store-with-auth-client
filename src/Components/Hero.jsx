...
const Hero = () => {
    return (
        <div>
             <div style={{ backgroundImage: `url(${'/hero.png'})` }} className="h-[620px] md:h-[750px] w-full text-white flex items-center rancho justify-end">
          <div className="flex flex-col gap-6 md:w-2/4 mx-6">
            ...
            <button className="text-2xl font-medium w-fit px-6 py-2 text-[#242222] bg-[#E3B577]">Learn More</button>
          </div>
        </div>
        </div>
    );
